...
export const products = [
  ...
  // ── MEN'S SECTION EXPANSION (18 new items) ──
  {
    ...
    discountPercentage: 24,
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [{ name: 'Indigo', hex: '#2F4F4F', images: ['https://images.pexels.com/photos/915915/pexels-photo-915915.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/915915/pexels-photo-915915.jpeg?w=600&h=800&fit=crop', alt: 'Classic Denim Jacket', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['M', 'L', 'XL'],
    colors: [{ name: 'Navy/White', hex: '#000080', images: ['https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=600&h=800&fit=crop', alt: 'Striped Cotton Polo', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 24,
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [{ name: 'Sky Blue', hex: '#87CEEB', images: ['https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?w=600&h=800&fit=crop', alt: 'Slim Fit Linen Shirt', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 26,
    sizes: ['30', '32', '34', '36'],
    colors: [{ name: 'Khaki', hex: '#F0E68C', images: ['https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?w=600&h=800&fit=crop', alt: 'Chino Shorts', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [{ name: 'Olive Green', hex: '#556B2F', images: ['https://images.pexels.com/photos/701877/pexels-photo-701877.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/701877/pexels-photo-701877.jpeg?w=600&h=800&fit=crop', alt: 'Lightweight Bomber Jacket', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 26,
    sizes: ['One Size'],
    colors: [{ name: 'Gold / Dark Green', hex: '#D4AF37', images: ['https://images.pexels.com/photos/5650026/pexels-photo-5650026.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/5650026/pexels-photo-5650026.jpeg?w=600&h=800&fit=crop', alt: 'Aviator Sunglasses Gold', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 20,
    sizes: ['One Size'],
    colors: [{ name: 'Silver Mesh', hex: '#C0C0C0', images: ['https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=600&h=800&fit=crop', alt: 'Minimal Mesh Silver Watch', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['M', 'L', 'XL'],
    colors: [{ name: 'Mahogany Brown', hex: '#6D351A', images: ['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=800&fit=crop', alt: 'Mahogany Leather Belt', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['One Size'],
    colors: [{ name: 'Carbon Black Textures', hex: '#333333', images: ['https://images.unsplash.com/photo-1627123424574-724758594e93?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=600&h=800&fit=crop', alt: 'Carbon Fiber Wallet', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 24,
    sizes: ['One Size'],
    colors: [{ name: 'Silver Sterling', hex: '#EAEAEA', images: ['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=800&fit=crop', alt: 'Sterling Hoop Earrings', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 23,
    sizes: ['One Size'],
    colors: [{ name: 'Stealth Grey / Orange', hex: '#5A6065', images: ['https://images.pexels.com/photos/1232459/pexels-photo-1232459.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/1232459/pexels-photo-1232459.jpeg?w=600&h=800&fit=crop', alt: 'Sport Backpack', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    sizes: ['One Size'],
    colors: [{ name: 'Tortoiseshell / Gold', hex: '#6E473B', images: ['https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg?w=600&h=800&fit=crop', alt: 'Retro Sunglasses Tortoise', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 20,
    sizes: ['One Size'],
    colors: [{ name: 'Rose Gold / Dark Brown', hex: '#8B5A2B', images: ['https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=600&h=800&fit=crop', alt: 'Rose Gold Chronograph Watch', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 20,
    sizes: ['One Size'],
    colors: [{ name: 'Rust Orange Suede', hex: '#C04000', images: ['https://images.pexels.com/photos/691046/pexels-photo-691046.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/691046/pexels-photo-691046.jpeg?w=600&h=800&fit=crop', alt: 'Suede Crossbody Bag Orange', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 20,
    sizes: ['One Size'],
    colors: [{ name: '18k Gold Plated', hex: '#FFD700', images: ['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=800&fit=crop', alt: 'Gold Link Chain Necklace', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 23,
    sizes: ['One Size'],
    colors: [{ name: 'Olive Drab Canvas', hex: '#556B2F', images: ['https://images.pexels.com/photos/1232459/pexels-photo-1232459.jpeg?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.pexels.com/photos/1232459/pexels-photo-1232459.jpeg?w=600&h=800&fit=crop', alt: 'Canvas Duffle Bag Olive', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 21,
    sizes: ['One Size'],
    colors: [{ name: 'Heather Charcoal', hex: '#3E3E3E', images: ['https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=600&h=800&fit=crop', alt: 'Cashmere Knit Scarf Grey', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['One Size'],
    colors: [{ name: 'Silver Chrome / Black', hex: '#8A8A8A', images: ['https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&h=800&fit=crop', alt: 'Chrome Frame Flat Top Sunglasses', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['One Size'],
    colors: [{ name: 'Matte Black', hex: '#111111', images: ['https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&h=800&fit=crop', alt: 'Smart Hybrid Watch Black', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 25,
    sizes: ['One Size'],
    colors: [{ name: 'Crimson Wine Red', hex: '#722F37', images: ['https://images.unsplash.com/photo-1627123424574-724758594e93?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=600&h=800&fit=crop', alt: 'Crimson Passport Case', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 23,
    sizes: ['One Size'],
    colors: [{ name: 'Turquoise Blue / Gold', hex: '#40E0D0', images: ['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=800&fit=crop', alt: 'Boho Stone Necklace', isPrimary: true, order: 1 }],
  ...
  },
  {
    ...
    discountPercentage: 21,
    sizes: ['M', 'L', 'XL'],
    colors: [{ name: 'Sand Beige Suede', hex: '#C2B280', images: ['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=800&fit=crop'] }],
    images: [{ url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=800&fit=crop', alt: 'Sand Suede Leather Belt', isPrimary: true, order: 1 }],
