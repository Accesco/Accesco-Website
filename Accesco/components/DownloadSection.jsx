    ...
    <section style={{ padding: "0 40px 80px", background: "#FFFDF8" }}>
      <div
        style={{
          ...
          margin: "0 auto",
          background:
            "linear-gradient(135deg, #1A0A0F 0%, #2D0818 50%, #1A0A0F 100%)",
          borderRadius: "32px",
          padding: "72px 60px",
          position: "relative",
          overflow: "hidden",
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(122,0,66,0.22) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        <div className={styles.dlGrid}>
          ...
          <div>
            ...
            >
              From 10-minute{" "}
              <strong style={{ color: "#4CAF50" }}>Grokly</strong> deliveries to{" "}
              <strong style={{ color: "#9C27B0" }}>InstaStyle</strong> fashion
              rentals. Download Accesco!
            </p>

            {/* Store buttons */}
            <div
              className="dl-buttons-wrap"
              style={{
                display: "flex",
                gap: "12px",
                flexWrap: "nowrap",
