...
export default function InstaStyleFooter() {
  ...
  const socialLinks = [
    { 
      name: 'Instagram', 
      href: 'https://instagram.com/instastyle',
      icon: (
    ...
    { 
      name: 'Facebook', 
      href: 'https://facebook.com/instastyle',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    { 
      name: 'Twitter', 
      href: 'https://twitter.com/instastyle',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    { 
      name: 'YouTube', 
      href: 'https://youtube.com/instastyle',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.brandColumn}>
              ...
              <p className={styles.brandDescription}>
                Fashion delivered in 15-20 minutes. Try before you buy, shop sustainably, 
                and express yourself with InstaStyle.
              </p>
