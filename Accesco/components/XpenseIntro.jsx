...
export default function XpenseIntro() {
  ...
  const percentageUsed = Math.min(
    Math.round((overallTotal / budgetLimit) * 100),
    100,
  );
  ...
  const getIcon = (iconName, className = "") => {
    switch (iconName) {
      case "ShoppingCart":
        return <ShoppingCart className={className} size={18} />;
      case "Utensils":
        return <Utensils className={className} size={18} />;
      case "Shirt":
        return <Shirt className={className} size={18} />;
      case "Clock":
        return <Clock className={className} size={22} />;
      case "UserCheck":
        return <UserCheck className={className} size={22} />;
      case "TrendingUp":
        return <TrendingUp className={className} size={22} />;
      case "Lock":
        return <Lock className={className} size={14} />;
      case "RefreshCw":
        return <RefreshCw className={className} size={14} />;
      case "Sparkles":
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: "0.75rem", color: "#888892", margin: 0 }}>
                  Smart Personal Finance Sandbox
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <circle
                        ...
                        style={{
                          stroke: percentageUsed > 85 ? "#ef4444" : "#ffffff",
                        }}
                      />
                    </svg>
                    <div className="radial-text-content">
                      <span className="radial-percentage-num">
                        {percentageUsed}%
                      </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {tx.date} • {tx.category.toUpperCase()}
                          </p>
                        </div>
                      </div>
          ...
          <div className="left-hero-card">
            <div>
              ...
              <p className="hero-subtitle">
                Your smart spending companion for Grocery, Food & Fashion - all
                in one place.
              </p>
          ...
          <div className="right-dashboard-card" ref={dashboardRef}>
            ...
            <div className="dashboard-header">
              <div className="header-text-group">
                ...
                <span className="header-sub-main">
            ...
            <div className="dashboard-grid-content">
              ...
              <div
                className={`black-card-inner ${activeTab === "Track" ? "focus-tab-element" : ""}`}
              >
                <div className="card-top-header">
                  <h3 className="card-title">Track all your spending</h3>
                  <p className="card-desc">
                    {activeTab === "Track" &&
                      "Automatically tracks your Grocery, Food & Fashion spends in one place."}
                    {activeTab === "Budget" &&
                      "Monitor category breakdowns relative to your overall monthly spend limits."}
                    {activeTab === "Insights" &&
                      "Smart algorithms separate static food runs from dynamic shopping sprees."}
                  </p>
                </div>
                ...
                {viewDetails && (
                  <div className="expanded-details-container">
                    {extraCategories.map((cat) => (
                      <div
                        className="spend-list-item spend-list-item--indented"
                        key={cat.id}
                      >
                        <div className="spend-item-left">
                          ...
                          <span className="spend-category-name spend-category-name--muted">
                            {cat.name}
                          </span>
                        </div>
                        <span className="spend-amount spend-amount--sm">
                          ₹{cat.amount.toLocaleString()}
                        </span>
                      </div>
                    ))}
              ...
              >
                <div className="card-top-header">
                  ...
                  <p className="card-desc">
                    We help you stay on track with smart budget monitoring and
                    real-time insights.
                  </p>
                </div>
                ...
                <div className="budget-radial-section">
                  <div className="budget-radial-info">
                    <span className="budget-val-label">
                      of{" "}
                      <span className="budget-val-total">
                        ₹{budgetLimit.toLocaleString()}
                      </span>
                    </span>
                ...
                <div className="insight-box-card">
                  {activeTab === "Track" && (
                    <>
                      <p className="insight-text-bold">
                        Food spending is stable this week.
                      </p>
                      <p className="insight-text-sub">
                        You spent ₹150 less than last week.
                      </p>
                    </>
                  )}
                  {activeTab === "Budget" && (
                    <>
                      <p className="insight-text-bold">
                        Excellent control on Fashion!
                      </p>
                      <p className="insight-text-sub">
                        82% of clothing budget remains untouched.
                      </p>
                    </>
                  )}
                  {activeTab === "Insights" && (
                    <>
                      <p className="insight-text-bold">
                        Weekend Spike detected in Food.
                      </p>
                      <p className="insight-text-sub">
                        Ordering on Friday drove up weekly average by 12%.
                      </p>
                    </>
                  )}
                </div>
                ...
                <div className="action-buttons-row">
                  ...
                  <button
                    onClick={navigateToDashboard}
                    className="glossy-btn-outline"
                  >
                    Go to Xpense Meter{" "}
                    <ArrowRight size={12} className="icon-ml-2" />
                  </button>
                </div>
