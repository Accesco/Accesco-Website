...
const pressReleases = [
  ...
  },
  {
    ...
    date: 'June 19, 2026',
    category: 'Media Coverage',
    excerpt: 'An in-depth analysis of Accesco Living circular commerce model and how its intelligent hyperlocal platform is set to redefine convenience for Indian households.',
    image: '/images/head5.jpeg',
    readTime: '5 min read',
    url: 'https://entrepreneurorbit.com/how-accesco-living-will-change-the-quick-commerce-industry/',
    logo: '/logos/orbit.jpeg',
  },
  {
    id: 13,
    title: 'Visionaries Under 20: Argha Sengupta and the Future of Intelligent Living Platforms',
    date: 'June 17, 2026',
    category: 'Featured Article',
    excerpt: 'Express Visionary profiles Argha Sengupta — the teenager building what may be India most ambitious commerce platform — combining groceries, fashion, food, and finance under one roof.',
    image: '/images/head4.jpeg',
    readTime: '7 min read',
    url: 'https://expressvisionary.com/argha-sengupta-accesco-living-visionary/',
    logo: '/logos/expressvisionary.jpeg',
  },
  {
    id: 12,
    title: 'Accesco Living: The Hyperlocal Super App Taking On Blinkit, Swiggy and Myntra at Once',
    date: 'June 16, 2026',
    category: 'Media Coverage',
    excerpt: 'Could a 19-year-old from Siliguri outmaneuver India biggest tech companies? Accesco Living is betting big on AI-driven personalisation and circular commerce.',
    image: '/images/head3.jpeg',
    readTime: '6 min read',
    url: 'https://businessinsider.in/accesco-living-super-app-india/',
    logo: '/logos/businessinsider.jpeg',
  },
  {
    id: 11,
    title: "Inside Accesco Living: Building India's Next-Generation Unified Commerce App",
    date: 'June 15, 2026',
    category: 'Media Coverage',
    excerpt: 'An in-depth feature on how Accesco Living is integrating hyperlocal delivery, circular economy practices, and next-generation unified commerce to transform consumer habits in India.',
    image: '/images/head1.jpeg',
    readTime: '5 min read',
    url: 'https://www.bizinnovates.com/inside-accesco-living-building-indias-next-generation-unified-commerce-app/',
    logo: '/logos/bizz.png',
  },
  {
    id: 10,
    title: 'Startup Spotlight: Accesco Living Builds India First Circular Commerce Ecosystem',
    date: 'June 15, 2026',
    category: 'Media Coverage',
    excerpt: 'Bengaluru-based Accesco Living is making headlines with its ambitious plan to unify fragmented consumer services under one AI-powered platform targeting 20 million users.',
    image: '/images/head2.jpeg',
    readTime: '4 min read',
    url: 'https://businessnewsindia.com/accesco-living-circular-commerce-ecosystem/',
    logo: '/logos/businessnews.jpeg',
  },
  {
    id: 9,
    title: 'How Accesco Living Is Redefining Smart Commerce for the Modern Indian Household',
    date: 'June 14, 2026',
    category: 'Media Coverage',
    excerpt: 'Accesco Living is on a mission to become the single intelligent platform that manages every household need — from groceries and food delivery to fashion and healthcare.',
    image: '/images/head1.jpeg',
    readTime: '5 min read',
    url: 'https://businessscope.in/accesco-living-redefining-smart-commerce/',
    logo: '/logos/business-scope.jpeg',
  },
  {
    id: 8,
