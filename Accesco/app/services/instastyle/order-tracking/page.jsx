...
function OrderTrackingContent() {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      // Interactive pulsing scooter rider pin with a production-level SVG icon (Replacing the emoji with Espresso theme)
      const riderIcon = L.divIcon({
        html: `<div style="
          ...
          justify-content: center;
          border: 2px solid white;
          box-shadow: 0 4px 15px rgba(62,33,27,0.4);
          position: relative;
        ">
          ...
          <div style="
            ...
            border-radius: 6px;
            white-space: nowrap;
            box-shadow: 0 4px 12px rgba(62,33,27,0.15);
          ">0.6 km</div>
        </div>`,
      ...
      // Render Espresso Brown dashed routing track line matching input_file_12.png perfectly
