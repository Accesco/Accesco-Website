    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            onClick={() => router.push("/services/instastyle")}
            style={{
              padding: "8px 16px",
              borderRadius: "8px",
        ...
        <div className={styles.filters}>
          ...
          <button
            className={`${styles.filterBtn} ${filter === "PLACED" || filter === "CONFIRMED" || filter === "PACKING" || filter === "OUT_FOR_DELIVERY" ? styles.active : ""}`}
          ...
          <div className={styles.orderList}>
            {filteredOrders.map((order) => (
              <div
                ...
                onClick={() =>
                  router.push(`/services/instastyle/orders/${order.id}`)
                }
              >
                <div className={styles.orderMain}>
                  ...
                  <div className={styles.orderInfo}>
                    ...
                    >
                      <div
                        className={`${styles.orderStatus} ${styles[`status-${order.status}`]}`}
                      >
                  ...
                  {order.status !== "DELIVERED" ? (
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        router.push(
                          `/services/instastyle/order-tracking?id=${order.id}`,
                        );
                      }}
                    >
                      Track Order
