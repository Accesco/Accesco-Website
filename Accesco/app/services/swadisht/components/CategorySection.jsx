...
const categories = [
  { name: 'Biryani',      image: '/images/swadisht/categories/biriyani.png',   href: '/services/swadisht/categories?category=biryani' },
  { name: 'South Indian', image: '/images/swadisht/categories/dosa.png',       href: '/services/swadisht/categories?category=south-indian' },
  { name: 'North Indian', image: '/images/swadisht/categories/north-indian.png', href: '/services/swadisht/categories?category=north-indian' },
  ...
  { name: 'Thali',        image: '/images/thali-engine.png',                  href: '/services/swadisht/thali-engine' },
  ...
  { name: 'Coastal',      image: '/images/swadisht/categories/coastal.jpg',    href: '/services/swadisht/categories?category=coastal' },
